    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preference', models.CharField(default='no_preference', max_length=15)),
                ('occasion', models.CharField(default='None', max_length=15)),
                ('special_requests', models.TextField(blank=True, default='None', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='name', to='homeapp.itemlist')),
            ],
        ),
        migrations.CreateModel(
            name='Orders',
